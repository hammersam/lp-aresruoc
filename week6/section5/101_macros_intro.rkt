...
; 1. A macro definition describes how to transform some new syntax into
; different syntax in the source language.(adding more syntactic sugar to
; the language.)
; 2. Macro expansion occurs before evalution.
